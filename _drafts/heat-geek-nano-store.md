...
* Been heavily insulated and sits on feet so actual dimensions are 620mm deep, 320mm wide and 550mm high. Volume is 0.109m³. Holds about 60L of water total.
* Significantly smaller than MiniStore and being cuboid leaves more usable space. Occupies space below lower shelf in picture.
...
* NanoStore is all about combi-like operation. Water has eight times the heat capacity of steel, so a 110L MiniStore can store much more heat than a 100Kg+60L NanoStore. NanoStore is much better at transferring the heat generated by the heat pump, once it starts running. 
