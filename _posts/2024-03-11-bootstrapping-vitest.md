...
I've got a long way to go before I have a reasonably complete set of tests. There's also plenty [more toys](https://vitest.dev/guide/features.html) to play with: coverage tools, a nice UI, concurrent execution of tests, type testing, integration with Visual Studio Code, ...